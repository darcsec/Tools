#!/usr/bin/env python3
"""
generate_passwords_onefile.py

Generate N random passwords and write them into ONE output file.

Usage example:
  python3 generate_passwords_onefile.py --count 500000000 --length 12 --outfile passwords.txt --crypto
  python3 generate_passwords_onefile.py --count 500000000 --length 12 --outfile passwords.txt.gz --gzip
"""
